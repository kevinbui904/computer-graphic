...
void setSceneUniforms(uint32_t imageIndex) {
    ...
    Note that lightOrigin needs to be a unit vector
    */
    float lightOrigin[3] = {0.4082, 0.4082, 0.8165};
    float lightColor[3] = {1.0, 1.0, 1.0};

    vecCopy(3, lightOrigin, sceneUnifs.uLight);
    vecCopy(3, lightColor, sceneUnifs.cLight);
    /* Copy the bits. */
	void *data;
	vkMapMemory(
