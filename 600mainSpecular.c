...
int initializeScene() {
    ...
    and NULL for the new arguments
...
struct SceneUniforms {
    float cameraT[4][4];
    float uLightDirectional[4];
    float cLightDirectional[4];
...
void setSceneUniforms(uint32_t imageIndex) {
    ...
    else the light gets scaled by a factor of the length
    */
    float directionalLightUnit[3] = {0.4082, 0.4082, 0.8165};
    float directionalLightColor[3] = {brightness, brightness, brightness};
